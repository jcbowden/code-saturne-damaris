...
/*----------------------------------------------------------------------------
 * Initialize FVM to Damaris object writer.
 *
 * Options are:
 ...
 *
 * returns:
 *   pointer to opaque Damaris writer structure.
 *----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
 * Finalize FVM to damaris object writer.
 *
 * parameters:
...
/*----------------------------------------------------------------------------
 * Write nodal mesh to a a Damaris object
 *
 * parameters:
 *   this_writer_p <-- pointer to associated writer.
...
void
fvm_to_damaris_flush(void  *this_writer_p);

/*----------------------------------------------------------------------------*/

END_C_DECLS

#endif /* defined(HAVE_DAMARIS) */

#endif /* __FVM_TO_DAMARIS_H__ */
